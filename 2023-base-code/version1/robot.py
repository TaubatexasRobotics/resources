...
class MyRobot(wpilib.TimedRobot):
    ...
    def teleopPeriodic(self):
        ...
        if self.stick.getRawButtonPressed(5) == True:
            ...
            self.m_arm_angle_pid.setReference(
                angle_position + 1, rev.CANSparkMax.ControlType.kPosition
            )
        ...
        if self.stick.getRawButtonPressed(7) == True:
            ...
            self.m_arm_lenght_pid.setReference(
                lenght_position + 0.5, rev.CANSparkMax.ControlType.kPosition
            )
