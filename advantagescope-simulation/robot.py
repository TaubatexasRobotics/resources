...
from wpilib import SmartDashboard, Field2d  # Ferramentas para monitoramento e visualização
...
class MyRobot(wpilib.TimedRobot):
    def robotInit(self):
        ...
        self.direita.setInverted(True)  # Inverte motores à direita para girar corretamente

        # Configura o sistema de tração do robô
        self.tracao = wpilib.drive.DifferentialDrive(self.esquerda, self.direita)
        self.tracao.setSafetyEnabled(True)  # Ativa segurança para evitar comandos perigosos
        ...
        self.selector.addOption("Avançar, Girar 90°, Avançar", 2) # Move, gira -90°, move novamente
    ...
    def teleopPeriodic(self):
        ...
        rotacao = -self.joystick.getRawAxis(4)     # Eixo X: girar esquerda/direita (inverte para consistência)
    ...
    def autonomousPeriodic(self):
        ...
        if self.autonomous_mode == 1 and tempo < 1.0:
            ...
            if tempo < 1.0:
                ...
                relative_heading = ((relative_heading + 180) % 360 - 180)  # Normaliza para [-180, 180]
